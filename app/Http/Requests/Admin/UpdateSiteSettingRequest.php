...
class UpdateSiteSettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'about_photo'       => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:8192'],
            'classes_section_photo' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:8192'],
            'pool_section_photo' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:8192'],
            ...
            'gallery_header_photo' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:8192'],
            'gallery_header_youtube_url' => [
                'nullable', 'string', 'max:255',
                'regex:/^(https?:\/\/)?(www\.)?(youtube\.com|youtu\.be)\/.+$/',
            ],
            'event_header_type'  => ['required', 'in:photo,video'],
            'event_header_photo' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:8192'],
            'event_header_youtube_url' => [
                'nullable', 'string', 'max:255',
                'regex:/^(https?:\/\/)?(www\.)?(youtube\.com|youtu\.be)\/.+$/',
            ],
            'team_header_type'  => ['required', 'in:photo,video'],
            'team_header_photo' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:8192'],
            'team_header_youtube_url' => [
                'nullable', 'string', 'max:255',
                'regex:/^(https?:\/\/)?(www\.)?(youtube\.com|youtu\.be)\/.+$/',
            ],
            'join_header_type'  => ['required', 'in:photo,video'],
            'join_header_photo' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:8192'],
